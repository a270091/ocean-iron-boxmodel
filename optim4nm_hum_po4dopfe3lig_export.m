...
[f_ini,dfe_ini] = costf4_hum_boxmodel_po4dopfe3lig_export(pvec_ini);
...
for k=1:ni
  ...
  for l=1:ni,
    ...
    for m=1:ni,
       ...
       [pvec,cost] = fminsearch(@costf4_hum_boxmodel_po4dopfe3lig_export, pvec_ini,options);
       nn = nn+1;
       pvec_all(nn,:) = pvec(:);
       cost_all(nn) = cost;
    end
