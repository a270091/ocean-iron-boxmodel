...
pvec_dimensional(2) = 0.1*0.01; % params.KFe_bact
pvec_dimensional(3) = 10.0;     % params.khum
pvec_dimensional(4) = 1.8 * 2.5e-4 * 116 * 0.67;   % params.rlig2p2
pvec_dimensional(5) = 0.5*0.1;  % params.sidremin
pvec = pvec_ini;

[f_ini,dfe_ini] = costf_hum_boxmodel_po4dopfe3lig_export(pvec_ini);
...
for k=1:nk
  ...
  for m=1:nm
    ...
    p2(m) = pvec(4);
    misfit(k,m) = costf_hum_boxmodel_po4dopfe3lig_export(pvec);
  end
end
